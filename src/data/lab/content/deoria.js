...
export const deoriaContent = [
...

  {
    ...
    h: "Deoria Jile Me Home Sample Collection Kahan Kahan Hoti Hai",
    p: [
      "Collection Deoria Sadar ke saath saath jile ke kasbon me bhi hoti hai — Rudrapur, Barhaj, Salempur, Bhatpar Rani, Gauri Bazar aur Baitalpur. Aap in kasbon ke aas paas ke gaon me rehte hain aur sure nahi hain ki aapka address cover hota hai ya nahi, to booking se pehle ek call kar lijiye; hum saaf bata denge, taaki aap intezaar kar ke pareshan na hon.",
...

  {
    ...
    h: "Baadh Aur Paani Se Failne Wali Bimariyan — Jaundice Aur Typhoid",
    p: [
...

  {
    ...
    h: "Khoon Ki Kami (Anaemia) — Deoria Me Sabse Zyada Chhoot Jaane Wali Jaanch",
    p: [
...

  {
    ...
    h: "Bahar Kaam Karne Walon Ke Liye Checkup — Ghar Aane Par Ek Baar",
    p: [
      ...
      "Agar bahar rehte hue lagatar bukhar, wazan girna, khaansi ya peeliyapan raha ho, to ye baat booking ke waqt zaroor bataiye aur doctor ko bhi. Aise me sirf routine package kaafi nahi hota, alag se jaanch chahiye hoti hai.",
    ],
  },

  {
    id: "diabetes-thyroid-screening-deoria",
    h: "Diabetes, Thyroid Aur BP — Kis Umar Me Kya Karana Chahiye",
    p: [
...

  {
    ...
    h: "Deoria Me Full Body Checkup — Kaunsa Package Kiske Liye",
    p: [
...

  {
    ...
    h: "Deoria Me Lab Test Ka Price — Kya Dena Hoga",
    p: [
      ...
      "Aam test ke price ise tarah hain: Blood Sugar ₹100, CBC ₹400, Thyroid Profile (T3, T4, TSH) ₹550, HbA1c ₹600, Liver Function Test ₹600, Kidney Function Test ₹700, Lipid Profile ₹800, Vitamin D ₹1,000, Vitamin B12 ₹1,200 aur Dengue (NS1, IgG, IgM) ₹1,200.",
...

  {
    ...
    h: "Sample Dene Se Pehle Kya Karein, Kya Na Karein",
    p: [
  ...
  {
    id: "reports-deoria",
    h: "Report Kab Milegi Aur Use Kaise Padhein",
    p: [
...

  {
    ...
    h: "Deoria Me Lab Test Kaise Book Karein",
    p: [
      ...
      "Ek aakhri baat: agar aap Deoria jile ke kisi aise gaon me hain jo is page par naam se nahi likha, to maan kar mat baithiye ki service nahi hai. Ek call kar ke pooch lijiye — cover hota hai to wahi slot book ho jaayega, aur nahi hota to hum saaf bata denge.",
    ],
  },
];
 ...
 * what do I do about a child with fever and seizures. Only the first six render
 * (see page.js), so the two that decide a booking are placed first.
 *
...
export const deoriaFaqs = [
  {
    ...
    a: "Aap sirf test ka wahi price dete hain jo card par likha hai — Deoria me home sample collection bilkul free hai, na visiting charge na koi hidden fee. Blood Sugar ₹100, CBC ₹400, Thyroid Profile ₹550, Lipid Profile ₹800 aur Basic Full Body Checkup ₹999 se shuru hota hai. Payment sample lene ke waqt cash ya UPI se hota hai.",
  },
  {
  ...
  },
  {
    ...
    a: "Hum Deoria Sadar ke saath Rudrapur, Barhaj, Salempur, Bhatpar Rani, Gauri Bazar, Baitalpur aur inke aas-paas ke ilaakon me sample collect karte hain. Aapka gaon is list me naam se nahi hai to bhi ek baar call kar ke pooch lijiye — cover hone par usi waqt slot book ho jaayega. Pata likhte waqt ek landmark zaroor daaliye, kyunki yahan house number se zyada landmark kaam aata hai.",
  },
  {
