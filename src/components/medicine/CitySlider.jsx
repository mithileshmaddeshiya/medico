...
// Array ko saaf rakhein, sirf city ka slug daalein
const cities = [
  { name: "Deoria", slug: "deoria" },
  { name: "Bhatni", slug: "bhatni" },
  { name: "Salempur", slug: "salempur" },
  { name: "Barhaj", slug: "barhaj" },
  { name: "Lar", slug: "lar" },
];
          ...
          {cities.map((city, index) => {
            return (
              <SwiperSlide key={index}>
                {/* Clean and Solid URL Path for Googlebot */}
                <Link href={`/medicine-delivery/${city.slug}`} prefetch={true}>
                  <motion.div
                    whileHover={{ y: -4 }}
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs sm:text-sm text-gray-500 leading-5 sm:leading-6 line-clamp-3">
                        Trusted medicine delivery services available in {city.name}.
                      </p>
                    </div>
